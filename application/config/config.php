...
|
*/
//$config['base_url'] = 'http://localhost:8080/loginci/';
...
$config['sess_save_path'] = sys_get_temp_dir(); // Para tentar gravar em /tmp que geralmente é gravável
...
|
*/
$config['global_xss_filtering'] = TRUE; // Define a segurança da aplicação para envios de formulários
...
*/
$config['csrf_protection'] = TRUE; // Para segurança, verifica token de cookie CSRF ao enviar dados em formulário
